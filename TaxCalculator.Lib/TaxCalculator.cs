...
namespace TaxCalculator.Lib
{
    ...
    {
        Task<MonthlyTaxReport> CalculateAsync(string name, decimal annualSalary);
    }
    ...
    public class TaxCalculator : ITaxCalculator
    {
        ...
        public async Task<MonthlyTaxReport> CalculateAsync(string name, decimal annualSalary)
        {
            ...
            return await Task.FromResult(monthlyTaxReport);
        }
